...
//Write a program to find and print minimum spanning tree for a graph.
//Test this function with undirected weighted graph of n = 7 nodes.
//Assume that ifinity weight = 99, this is mean that there is no link between the two nodes.
#define dim 7
#define inf 99
int weight[dim][dim] =
{
